...
pub static APP_ID: &str = "io.github.verge-pro-rev.verge-pro-rev";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "verge-pro-rev-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.verge-pro-rev.verge-pro-rev.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "verge-pro-rev-backup-dev";
...
pub fn service_path() -> Result<PathBuf> {
    ...
    Ok(res_dir.join("verge-pro-service"))
}

#[cfg(windows)]
pub fn service_path() -> Result<PathBuf> {
    let res_dir = app_resources_dir()?;
    Ok(res_dir.join("verge-pro-service.exe"))
}
