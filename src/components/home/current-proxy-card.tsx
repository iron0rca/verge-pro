...
// 本地存储的键名
const STORAGE_KEY_GROUP = "verge-pro-selected-proxy-group";
const STORAGE_KEY_PROXY = "verge-pro-selected-proxy";
const STORAGE_KEY_SORT_TYPE = "verge-pro-proxy-sort-type";
